...
来自ODM厂商天思智慧Skysi，型号X5
人工手动逆向还原设备树源码，目前还未完成。

目前市场上可公开购买的有两个定制版本：
- 格蠹科技(Gedu)的幽兰代码本(Yourland CodeBook)
- 深开鸿(Kaihong)的BotBook
...
![image](https://skysi.com.cn/template/zh-cn/images/de-img3.jpg)
